...
import type { TwoslashReturn } from "../src/types/index.ts";
import { splitFiles } from "../src/utils.ts";
...
describe(parentSuiteName, () => {
	it("split files", async () => {
		await allure.parentSuite(parentSuiteName);
		await allure.suite("new tests");
		await allure.subSuite("split files");
...
`,
  ...
  `);
	...
	it("should pass", async () => {
		await allure.parentSuite(parentSuiteName);
		await allure.suite("new tests");
		await allure.subSuite("should pass");
