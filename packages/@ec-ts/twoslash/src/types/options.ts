...
import type { HandbookOptions } from "./handbook-options.ts";
import type { TwoslashReturnMeta } from "./returns.ts";
...
export interface TwoslashExecuteOptions
	extends Partial<
		Pick<TwoslashReturnMeta, "positionQueries" | "positionCompletions" | "positionHighlights">
	> {
	/**
