...
```ts
import { createSystem } from "@ec-ts/vfs"
...
```ts
import { createSystem, createVirtualTypeScriptEnvironment } from "@ec-ts/vfs"
...
```ts
import { createDefaultMapFromCDN } from "@ec-ts/vfs"
import ts from "typescript"
